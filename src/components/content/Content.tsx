...
const Content = () => {
  ...
  return (
    <Box sx={{p:3, width:700, display:'flex',justifyContent:'center', flexDirection:'column', m:'0 auto' }}>
        
        <Grid container spacing={0} direction={'row'} columnGap={2} p={1} sx={{width:550}}>
        ...
        <Box sx={{width: '100%',rowGap:1, display:'flex', flexDirection:'column', height: 700, overflowY:'scroll'}}>
